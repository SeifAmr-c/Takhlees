      ...
      <main className="flex-1 lg:ml-64 pt-16 lg:pt-0">
        <div className="p-4 sm:p-6 lg:p-8">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6 lg:mb-8">
            <div>
              <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Welcome back, Ahmed! 👋</h1>
              <p className="text-sm sm:text-base text-gray-600">Here's what's happening with your clearance requests</p>
            </div>
            <div className="flex items-center gap-2 sm:gap-4">
              <div className="relative flex-1 sm:flex-none">
                <input
                  type="text"
                  placeholder="Search..."
                  className="w-full sm:w-48 lg:w-64 pl-9 sm:pl-10 pr-4 py-2 sm:py-2.5 border border-gray-200 rounded-lg focus:border-blue-500 focus:ring-0 text-sm"
                />
              ...
              <button className="relative p-2 sm:p-2.5 bg-white border border-gray-200 rounded-lg hover:bg-gray-50 flex-shrink-0">
                <svg className="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 17h5l-1.405-1.405A2.032 2.032 0 0118 14.158V11a6.002 6.002 0 00-4-5.659V5a2 2 0 10-4 0v.341C7.67 6.165 6 8.388 6 11v3.159c0 .538-.214 1.055-.595 1.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9" />
                </svg>
                <span className="absolute top-1 right-1 w-2 h-2 bg-red-500 rounded-full"></span>
              </button>
              <div className="w-8 sm:w-10 h-8 sm:h-10 bg-blue-600 rounded-lg flex items-center justify-center text-white font-semibold text-sm sm:text-base flex-shrink-0">
                AM
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm">
            <div className="px-4 sm:px-6 py-3 sm:py-4 border-b border-gray-200 flex items-center justify-between">
              ...
              <a href="#" className="text-blue-600 font-medium text-xs sm:text-sm hover:underline">View All →</a>
            </div>
              ...
              {requests.map((req, i) => (
                <div key={i} className="border border-gray-100 rounded-lg p-4">
                  <div className="flex items-center justify-between mb-3">
                    <span className="font-semibold text-blue-600 text-sm">{req.id}</span>
                    <span className={`px-2 py-1 rounded-full text-xs font-semibold ${req.statusColor}`}>
                      {req.status}
                    </span>
                  </div>
                  <p className="text-sm text-gray-900 font-medium mb-1">{req.service}</p>
                  <p className="text-xs text-gray-600 mb-1">{req.company}</p>
