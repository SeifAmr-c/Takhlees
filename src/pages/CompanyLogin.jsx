        ...
        <div className="relative z-10">
          ...
          <div className="mt-12 space-y-4">
            <div className="flex items-center gap-4 text-green-200">
              ...
              <span className="text-sm xl:text-base">Manage incoming service requests</span>
            </div>
            <div className="flex items-center gap-4 text-green-200">
              <svg className="w-5 xl:w-6 h-5 xl:h-6 text-green-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-sm xl:text-base">Track revenue and analytics</span>
            </div>
            <div className="flex items-center gap-4 text-green-200">
              <svg className="w-5 xl:w-6 h-5 xl:h-6 text-green-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              </svg>
              <span className="text-sm xl:text-base">Connect with importers</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-4 sm:p-6 lg:p-8 bg-white min-h-screen lg:min-h-0">
        <div className="w-full max-w-md py-6 sm:py-8">
          ...
          <div className="mb-6 sm:mb-8 text-center lg:text-left">
            <h2 className="text-2xl sm:text-3xl font-bold text-green-800 mb-2">Company Sign In</h2>
            <p className="text-sm sm:text-base text-gray-600">Access your company dashboard</p>
          </div>
          ...
          <form className="space-y-4 sm:space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 sm:pl-12 pr-4 py-3 sm:py-3.5 border-2 border-gray-200 rounded-xl focus:border-green-500 focus:ring-0 transition text-sm sm:text-base"
                />
              </div>
            </div>
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 sm:gap-0">
              ...
              <a href="#" className="text-xs sm:text-sm text-green-600 font-semibold hover:underline">Forgot Password?</a>
            </div>
