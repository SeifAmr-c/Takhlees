    ...
    <div className="min-h-screen bg-gray-50 flex">
      ...
      <main className="flex-1 ml-64 p-8">
        <div className="max-w-3xl mx-auto">
          <div className="mb-8">
            <h1 className="text-2xl font-bold text-gray-900">Submit Clearance Application</h1>
            <p className="text-gray-600">Fill in the details below to request port clearance services</p>
          </div>

          {/* Progress Steps */}
          <div className="flex items-center justify-between mb-8">
            {['Shipment Details', 'Select Company', 'Upload Documents', 'Review & Submit'].map((label, i) => (
          ...
          <div className="bg-white rounded-xl shadow-sm p-8">
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-2 gap-6">
                  <div>
                    ...
                    <select className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:border-blue-500">
                ...
                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Shipment Description</label>
                  <textarea 
                    rows={3}
                    placeholder="Describe your shipment (type of goods, quantity, etc.)"
                    className="w-full px-4 py-3 border border-gray-200 rounded-lg focus:border-blue-500"
                  ></textarea>
                </div>

                <div className="grid grid-cols-2 gap-6">
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-2">Estimated Value (EGP)</label>
                    <input 
                      type="text"
            ...
            {step === 2 && (
              <div className="space-y-6">
                <h2 className="text-xl font-semibold text-gray-900 mb-6">Select Clearance Company</h2>
                <div className="space-y-4">
                  {[
                    ...
                    <label key={i} className="flex items-center p-4 border-2 border-gray-200 rounded-xl cursor-pointer hover:border-blue-500 transition">
                      <input type="radio" name="company" className="w-5 h-5 text-blue-600" />
                      <div className="ml-4 flex-1">
                        <p className="font-semibold text-gray-900">{company.name}</p>
                        <p className="text-gray-500 text-sm">⭐ {company.rating} • Est. {company.time}</p>
                      </div>
                      <p className="font-bold text-blue-600">{company.price}</p>
                    </label>
                  ))}
                </div>
              </div>
            ...
            {step === 3 && (
              <div className="space-y-6">
                ...
                <div className="border-2 border-dashed border-gray-300 rounded-xl p-12 text-center">
                  ...
                  <button className="text-blue-600 font-semibold hover:underline">browse files</button>
                  <p className="text-gray-400 text-sm mt-2">PDF, JPG, PNG up to 10MB each</p>
                </div>
              ...
              <div className="space-y-6">
                ...
                <div className="bg-gray-50 rounded-lg p-6 space-y-4">
                  ...
                  <div className="border-t pt-4 flex justify-between">
                    ...
                    <span className="font-bold text-blue-600 text-xl">EGP 2,500</span>
                  </div>
                </div>
              </div>
            )}
