      ...
      `}>
        <div className="p-4 sm:p-6">
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            <span className="text-lg sm:text-xl font-bold text-gray-900">Takhlees</span>
          </div>
        </div>
        ...
        <nav className="mt-4 sm:mt-6">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 sm:px-6 py-3 text-gray-600 hover:bg-gray-50 font-medium text-sm sm:text-base"
          >
          ...
          <button className="w-full flex items-center gap-3 px-4 sm:px-6 py-3 text-gray-600 hover:bg-gray-50 font-medium text-sm sm:text-base">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
            </svg>
            My Requests
          </button>
          <button className="w-full flex items-center gap-3 px-4 sm:px-6 py-3 text-blue-600 bg-blue-50 border-r-4 border-blue-600 font-medium text-sm sm:text-base">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            onClick={() => { navigate('submit-application'); setSidebarOpen(false); }}
            className="w-full flex items-center gap-3 px-4 sm:px-6 py-3 text-gray-600 hover:bg-gray-50 font-medium text-sm sm:text-base"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button
            onClick={() => { navigate('track-order'); setSidebarOpen(false); }}
            className="w-full flex items-center gap-3 px-4 sm:px-6 py-3 text-gray-600 hover:bg-gray-50 font-medium text-sm sm:text-base"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div className="absolute bottom-0 w-full p-4 border-t border-gray-200">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 text-red-600 hover:bg-red-50 rounded-lg font-medium text-sm sm:text-base"
          >
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <main className="pt-16 lg:pt-0 lg:ml-64 min-h-screen">
        <div className="p-4 sm:p-6 lg:p-8">
          <div className="mb-6 sm:mb-8">
            <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Browse Clearance Services</h1>
            <p className="text-sm sm:text-base text-gray-600">Find verified companies for your port clearance needs</p>
          </div>
          ...
          <div className="bg-white p-4 sm:p-6 rounded-xl shadow-sm mb-6 sm:mb-8">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
              <div>
                <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1.5 sm:mb-2">Port</label>
                <select className="w-full px-3 sm:px-4 py-2 sm:py-2.5 border border-gray-200 rounded-lg focus:border-blue-500 text-sm sm:text-base">
              ...
              <div>
                <label className="block text-xs sm:text-sm font-medium text-gray-700 mb-1.5 sm:mb-2">Service Type</label>
                <select className="w-full px-3 sm:px-4 py-2 sm:py-2.5 border border-gray-200 rounded-lg focus:border-blue-500 text-sm sm:text-base">
                ...
                <div className="p-4 sm:p-6">
                  <div className="flex items-start justify-between mb-3 sm:mb-4">
                    <div className="flex-1 min-w-0">
                      <div className="flex items-center gap-2 flex-wrap">
                        <h3 className="text-base sm:text-lg font-bold text-gray-900 truncate">{company.name}</h3>
                        {company.verified && (
                          <span className="bg-blue-100 text-blue-700 text-xs px-2 py-0.5 rounded-full font-medium whitespace-nowrap">✓ Verified</span>
                        )}
                      </div>
                      <p className="text-gray-500 text-xs sm:text-sm mt-1">📍 {company.location}</p>
                    </div>
                    <div className="text-right ml-2 flex-shrink-0">
                      <div className="flex items-center gap-1 text-yellow-500">
                        <span>⭐</span>
                        <span className="font-semibold text-gray-900 text-sm sm:text-base">{company.rating}</span>
                      </div>
                  ...
                  <div className="flex flex-wrap gap-1.5 sm:gap-2 mb-3 sm:mb-4">
                    {company.services.map((service, j) => (
                      <span key={j} className="bg-gray-100 text-gray-700 text-xs sm:text-sm px-2 sm:px-3 py-0.5 sm:py-1 rounded-full">
                        {service}
                      </span>
                    ))}
                  </div>
                  <div className="flex items-center justify-between pt-3 sm:pt-4 border-t border-gray-100">
                    <p className="font-semibold text-gray-900 text-sm sm:text-base">{company.price}</p>
                    <button
                      onClick={() => navigate('submit-application')}
                      className="px-3 sm:px-5 py-1.5 sm:py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 transition text-xs sm:text-sm"
                    >
                      Request Quote
                    </button>
                  </div>
